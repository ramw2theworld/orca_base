...
Route::group(['middleware' => 'jwt.auth'], function () {
    Route::prefix('api/roles')->group(function (){
        Route::get('/', [RoleController::class, 'index'])->name('roles.index')->middleware('permission:fetch roles');
        ...
        Route::post('/{slug}/attach-detach-permissions', [RoleController::class, 'attachOrDetachPermissionsToRole'])->name('attach-detach.permissions');
